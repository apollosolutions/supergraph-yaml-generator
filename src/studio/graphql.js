...
(function (PrivateSubgraphShareStatus) {
    ...
    PrivateSubgraphShareStatus["Active"] = "ACTIVE";
    /** Creating the association failed */
    PrivateSubgraphShareStatus["CreateFailed"] = "CREATE_FAILED";
    /** Creating the association is in progress */
    PrivateSubgraphShareStatus["CreateInProgress"] = "CREATE_IN_PROGRESS";
    /** Deleting the association failed */
    PrivateSubgraphShareStatus["Deleted"] = "DELETED";
    /** Deleting the association failed */
    PrivateSubgraphShareStatus["DeleteFailed"] = "DELETE_FAILED";
    /** Deleting the association is in progress */
    PrivateSubgraphShareStatus["DeleteInProgress"] = "DELETE_IN_PROGRESS";
...
export function getSdk(client, withWrapper = defaultWrapper) {
    return {
        SubgraphsForVariant(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(SubgraphsForVariantDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphsForVariant', 'query');
        }
    };
}
