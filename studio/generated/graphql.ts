...
export type AccountMutation = {
  ...
  associate: Array<PrivateSubgraph>;
  ...
  disassociate: Array<PrivateSubgraph>;
...
export type AccountMutationAssociateArgs = {
...
export type AccountMutationDisassociateArgs = {
...
export type AccountMutationSyncArgs = {
  cloudProvider: CloudProvider;
};
...
export type AssociatePrivateSubgraphsInput = {
...
export type DisassociatePrivateSubgraphsInput = {
...
export type LintDiagnostic = {
  ...
  isCompositionHint: Scalars['Boolean'];
...
export type UpdateAwsShardInput = {
  ...
  loadbalancerArn?: InputMaybe<Scalars['String']>;
  loadbalancerListenerArn?: InputMaybe<Scalars['String']>;
...
export type SubgraphsForVariantQueryVariables = Exact<{
  ref: Scalars['ID'];
}>;


export type SubgraphsForVariantQuery = { __typename?: 'Query', variant?: { __typename: 'GraphVariant', id: string, subgraphs?: Array<{ __typename?: 'FederatedImplementingService', name: string }> | null, latestLaunch?: { __typename?: 'Launch', buildInput: { __typename: 'CompositionBuildInput', version?: string | null } | { __typename: 'FilterBuildInput' } } | null } | { __typename: 'InvalidRefFormat' } | null };


export const SubgraphsForVariantDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    SubgraphsForVariant(variables: SubgraphsForVariantQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SubgraphsForVariantQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SubgraphsForVariantQuery>(SubgraphsForVariantDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SubgraphsForVariant', 'query');
    }
  };
}
